...
If we would use two Nginx containers here, we would also need to set different HTTP ports for every container.  
...
We saw how to write test scenarios for a different amount of containers. 
